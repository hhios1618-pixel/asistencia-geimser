    ...
    <section className="flex flex-col gap-6">
      <header className="glass-panel flex flex-wrap items-center justify-between gap-3 rounded-3xl border border-white/70 bg-white/80 p-5 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.55)]">
        <div>
          ...
          <h2 className="text-xl font-semibold text-slate-900">Solicitudes de corrección</h2>
          <p className="text-sm text-slate-500">Aprueba o rechaza los ajustes enviados por los colaboradores.</p>
        </div>
      </header>
