...
export default function AdminPayrollClientPage() {
  return (
    <DashboardLayout
      title="Payroll"
      description="Calcula remuneraciones por días trabajados y variables por periodo."
      breadcrumb={[
      ...
      <Suspense
        fallback={
          <div className="glass-panel flex flex-col gap-3 rounded-[30px] border border-white/70 bg-white/85 p-6 text-sm text-slate-500">
            <span className="font-semibold text-slate-700">Cargando Payroll…</span>
            <span>Preparando periodos y corridas.</span>
          </div>
        }
      >
        <AdminPayrollClient />
